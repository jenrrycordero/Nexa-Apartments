		...
		<table class="acf-table">
			<tbody>
				...
				acf_render_field_wrap(array(
					...
					'value'			=> $field['razz-model-wrapper']['width'],
					'prepend'		=> __('width', 'acf'),
					'append'		=> '%',
					'razz-model-wrapper'		=> array(
						'data-name' => 'razz-model-wrapper'
					)
				), 'tr');
				...
				acf_render_field_wrap(array(
					...
					'name'			=> 'class',
					'prefix'		=> $field['prefix'] . '[wrapper]',
					'value'			=> $field['razz-model-wrapper']['class'],
					'prepend'		=> __('class', 'acf'),
					'razz-model-wrapper'		=> array(
						'data-append' => 'razz-model-wrapper'
					)
				), 'tr');
				...
				acf_render_field_wrap(array(
					...
					'name'			=> 'id',
					'prefix'		=> $field['prefix'] . '[wrapper]',
					'value'			=> $field['razz-model-wrapper']['id'],
					'prepend'		=> __('id', 'acf'),
					'razz-model-wrapper'		=> array(
						'data-append' => 'razz-model-wrapper'
					)
